...
<p>
  ...
  <a href="LICENSE"><img alt="license" src="https://img.shields.io/badge/license-MIT-F2F2F7?style=flat-square&labelColor=1C1C1E" /></a>
...
<table>
  ...
  <tr>
    ...
    <td><a href="#editor-experience"><strong>12. Editor</strong></a></td>
  </tr>
  <tr>
...
<img src="docs/assets/ui-workbench.jpg" alt="Workbench layout: editor, preview, diagrams" width="920" />

<sub>Figure 1. Workbench concept: structural editor, live preview, and parameterised diagrams (illustrative mock for documentation).</sub>

<br/><br/>

<img src="docs/assets/architecture-layers.jpg" alt="Layered architecture diagram" width="920" />

<sub>Figure 2. Layered architecture: UI, API with optimistic concurrency, event store and export pipelines.</sub>

<br/><br/>

<img src="docs/assets/graphic_kit.png" alt="lablog graphic kit" width="480" />

<sub>Figure 3. Project identity kit (logo system used across README, site, and packaging).</sub>
...
| Save (flush) | <kbd>Ctrl</kbd>+<kbd>S</kbd> |
| Find / replace | <kbd>Ctrl</kbd>+<kbd>F</kbd> / <kbd>Ctrl</kbd>+<kbd>H</kbd> |
| Undo / redo | <kbd>Ctrl</kbd>+<kbd>Z</kbd> / <kbd>Ctrl</kbd>+<kbd>Y</kbd> |
| Bold / italic / math | <kbd>Ctrl</kbd>+<kbd>B</kbd> / <kbd>I</kbd> / <kbd>E</kbd> |
| Toggle lab mode | configurable (Settings → shortcuts) |
| New page | configurable |
